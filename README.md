...
在输入信息的选择上，哪些信息是值得记录的？不同的藏品需要记录的信息也不一样。
...
分为两个部分
### a. > 将现场客流规模及其分布，与远程服务项目如网站、微博、微信、app 等的使用数量和偏好情况进行对比

主动兴趣。对观众进行分众化的研究和针对性的关注
### b. > 观众在每个展厅留驻的时长、分布的密度，热点区域的人流数量以及他们对相邻区域同等级展品的不同程度关注，随机参观路线形成的综合趋势———这些都体现了参观者对展陈语境普适性的“自我”反馈，能够帮助博物馆找到展陈的亮点与盲点，探索博物馆叙述与观众理解之间最佳的互动模式。

行为研究，有意识或者无意识的参观行为也能提供个性化信息

## ③遗产保护（线上3D复制品，燕遗协会的数字化工作坊（提一嘴就行）

像燕园遗产保护协会正在做的事情：扫描、复制文物细节，建立线上3D复制品来满足研究和观看的需要，可以在一定程度上减少藏品的损耗

# 2、数字技术的应用？数据的研究与呈现？ @hhq

## ①藏品研究（复制品与线上模型，信息量up、博物馆数据库对外开放、数据互通

### a.馆内藏品研究
#### i.馆内建设数据库--敦煌
有利于统一管理
困难：没有统一标准，有些标准不好分（矿泉水瓶和瓶盖）
#### ii.馆间统一数据库，数据互通
困难：老师上课讲过一些：比如某馆按年代分，某馆按器物分（青铜器、瓷器），就无法统一
但我个人认为从树状到分面组配会好一点解决这个问题（信息组织）
### b.馆外藏品研究
存在吗？会有博物馆外部人士想利用博物馆进行一些研究呢？
...
涉及到博物馆生存的问题，博物馆独有的资源是什么？--藏品，因此不愿意和其他博物馆公开，学者公开，大众公开。公开的越多，越不可能从中获利，越会“损失”。
另一个角度讲，博物馆的经费是由国家供给的，博物馆是公共文化服务机构，那么博物馆的资源理所应当被公众所利用。（引用公共文化服务相关法条）

## ②布展/展览呈现（数据可视化、建立线上博物馆（故宫的VR实景、（社区博物馆）
...
补充：声明条款下解法释法的空间。在实际操作中可以往有利于权利人的方向解释，同样也可以往另一方解释。
...
第一种，故宫的vr展，可以在网上浏览实体展览。定位是向因种种原因无法身临现场的观众能够同样看展。
